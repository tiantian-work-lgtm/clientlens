...
export const emptyReport: AnalysisReport = {
  ...
  profile: [],
  emotionProfile: { currentState: "待分析", currentStateEvidence: [], emotionTurningPoints: [], personalitySummary: "待分析", personalityTraits: [], decisionStyle: "待分析", decisionFactors: [], decisionPace: "待分析", communicationApproach: "待分析", decisionEvidence: [], confidence: 0 },
  productMentions: [],
  objections: [],
...
export const demoReport: AnalysisReport = {
  ...
  emotionProfile: {
    ...
    personalitySummary: "客户重视可核验信息，决策谨慎，会在关键风险明确后再推进。",
...
export const initialTasks: CustomerTask[] = [
  ...
  },
  {
    ...
    report: { ...demoReport, confidence: 0.79 },
  ...
  },
  {
    ...
    report: { ...demoReport, confidence: 0.91 },
